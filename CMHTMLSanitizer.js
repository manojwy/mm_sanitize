...
MM.HTMLSanitizer = (function(html4) {
    ...
    var OUTSIDE_TAG_TOKEN = new RegExp(
        ...
        //Patch: the third pattern was added to handle downleve-revealed conditional comments in IE
        //This is the original patter --->> + '|<\!--[\\s\\S]*?--\>|<!\\w[^>]*>|<\\?[^>*]*>'
        //Patch: the fourth condition is to remove empty iframes that are left after sanitization, this is to make sure that about:blank is not being loaded in clients
        + '|<\!--[\\s\\S]*?--\>|<!\\w[^>]*>|<\!\\W[^>]*>|<iframe[\\s\\S]*?\>|<\\?[^>*]*>'
            ...
            function sanitizeAttribs(tagName, attribs) {
                ...
                for (var i = 0; i < attribs.length; i += 2) {
                    ...
                    if ((attribKey = tagName + '::' + attribName,
                        ...
                        //console.log("Found atype");
                        atype = html4.ATTRIBS[attribKey];
                    }

                    //console.log("atype: " + atype + ", attribKey: " + attribKey);
